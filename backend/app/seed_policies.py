...
SEED_POLICIES = [
    ...
    },
    {
        ...
        "description": "Business class flights within Canada/US must not exceed $2,000 USD per leg",
        "rule_type": "max_price",
    ...
    {
        "name": "Max International Business Fare",
        "description": "International business class flights must not exceed $3,500 USD per leg",
        "rule_type": "max_price",
        "conditions": {"route_type": "international", "cabin": "business"},
        "threshold": {"amount": 3500, "currency": "USD"},
        "action": "warn",
        "severity": 9,
    },
    {
