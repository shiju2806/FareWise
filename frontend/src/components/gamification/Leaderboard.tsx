    ...
    <Card>
      ...
      <CardContent>
        <div className="space-y-1">
          <div className="grid grid-cols-[2rem_1fr_4rem_4rem_4rem] gap-2 text-xs text-muted-foreground font-medium pb-2 border-b">
            <span>#</span>
            <span>Name</span>
          ...
          {entries.map((e, i) => {
            ...
            return (
              <div
                key={e.user_id}
                className={`grid grid-cols-[2rem_1fr_4rem_4rem_4rem] gap-2 items-center py-1.5 text-sm ${
